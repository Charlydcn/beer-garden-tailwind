...
export default function BigArticle({ className = null, title, smallText, text, btn}) {
    return (
        <article className={`flex flex-col text-center max-w-[55rem] items-center py-20 min-h-[50svh] justify-center w-11/12 mx-auto leading-7 h-full ${className} sm:w-3/4 sm:aspect-square lg:min-h-0`}>
